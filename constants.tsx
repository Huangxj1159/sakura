...
export const TRANSLATIONS: TranslationMap = {
  ...
  [Language.EN]: {
    ...
    category_dustfree: "Dust-Free Series",
    ...
    home_subtitle: "Patented dust-free technology and eco-friendly solutions.",
    buy_now: "Shop Now",
...
export const INITIAL_PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    name: { TC: "无尘刀叉袋双色烫金logo外贸高档餐巾纸定制量小可印24小时发货", EN: "Dust-Free Cutlery Bag Dual Gold Foil Logo for Export" },
  ...
  },
  {
    ...
    name: { TC: "供应灰色无尘纸布触感宴会纸巾袋鼠袋刀叉袋折法可加印logo", EN: "Gray Dust-Free Cloth-Feel Banquet Kangaroo Bag" },
  ...
  },
  {
    ...
    name: { TC: "黑色木浆纸印彩色二维码外贸无尘纸巾印logo酒楼宴会餐厅餐巾纸", EN: "Black Pulp Color QR Code Dust-Free Napkin" },
  ...
  },
  {
    ...
    name: { TC: "黑色木浆纸印彩色二维码外贸无尘纸巾印logo酒楼宴会餐厅餐巾纸2", EN: "Black Pulp Color QR Code Dust-Free Napkin 2" },
    ...
    description: { TC: "第二款彩色二维码外贸无尘纸巾。", EN: "Second version of color QR code dust-free napkin." },
    stock: 10000, active: true
  },
  {
    id: "clk-9", category: "category_cloak",
    name: { TC: "红色刀叉袋印金logo无尘餐巾纸刀叉袋西餐布触感V折餐巾纸", EN: "Red Cutlery Bag Gold Logo Dust-Free Napkin" },
  ...
  },
  {
    ...
    description: { TC: "高檔酒店一次性彩色無塵餐巾紙，多顏色定制。", EN: "High-end hotel disposable colored dust-free napkins, multi-color customization." },
    stock: 10000, active: true
  },
// 📂 3️⃣ 无尘纸系列 DUST-FREE (df-1 ~ df-5)
{
...
},
{
  ...
  name: { TC: "厂家供应专利款彩色刀叉袋餐巾纸无尘纸可订颜色量小可接印LOGO", EN: "Patented Colored Cutlery Bag Napkin (Dust-Free/Custom Colors)" },
...
},
{
  ...
  name: { TC: "厂家直营欧美外贸订单麻布触感无尘餐巾纸印双色LOGO餐巾纸", EN: "Linen-Feel Dust-Free Napkin Dual Color Logo" },
  ...
  description: { TC: "麻布觸感無塵餐巾紙，歐美外貿訂單，雙色LOGO。", EN: "Linen-feel dust-free napkin, EU/US export orders, dual color logo." },
  stock: 10000, active: true
},
{
...
// 📂 4️⃣ 原材大卷轴 RAW_MATERIAL (rm-1 ~ rm-3)
{
  ...
  name: { TC: "批发大卷轴装染色无尘纸 染色竹浆纸接受來色樣定制餐巾紙原紙", EN: "Wholesale Jumbo Roll Dyed Dust-Free/Bamboo Pulp Paper" },
...
},
{
  ...
  name: { TC: "厂家直营大卷轴彩色染色竹浆纸无尘纸原纸餐巾纸酒店宴会量小可订", EN: "Large Roll Colored Bamboo Pulp Dust-Free Paper" },
...
},
{
  ...
  name: { TC: "厂家直营卡其色大卷轴彩色染色宴会西餐无尘纸无尘纸巾量小可订", EN: "Khaki Large Roll Colored Dust-Free Paper" },
  ...
  description: { TC: "卡其色大卷轴彩色染色无尘纸，宴会西餐适用。", EN: "Khaki large roll colored dust-free paper for banquet western dining." },
  stock: 10000, active: true
},
...
// 📂 5️⃣ 杯垫桌布系列 TABLEWARE (tb-1 ~ tb-2)
{
  ...
  name: { TC: "一次性无尘纸杯垫宴会商用定制烫金水墨印烙印压印环保无尘纸杯垫", EN: "Disposable Dust-Free Coaster (Gold Foil/Brand)" },
...
},
{
  ...
  name: { TC: "定制一次性无尘纸杯垫系列商用可烫金烙印压印LOGO环保无尘纸杯垫", EN: "Commercial Eco Dust-Free Coaster Series" },
...
},
{
  ...
  name: { TC: "日式温泉旅馆用湿毛巾 商务湿纸巾无尘纸支持来图来样定做", EN: "Japanese Onsen Dust-Free Wet Towel" },
...
},
{
  ...
  description: { TC: "一次性紙圍裙，環保無紡布無塵，支持來圖定制。", EN: "Disposable paper apron, eco non-woven dust-free, custom by image." },
  stock: 10000, active: true
},
{
  ...
  description: { TC: "燒烤火鍋專用一次性紙圍裙，環保無塵，支持來圖定制。", EN: "Disposable BBQ/hotpot paper apron, eco dust-free, custom by image." },
  stock: 10000, active: true
}
];