...
export const INITIAL_PRODUCTS: Product[] = [
  // 📂 1️⃣ 鎮店之寶 (category_treasures) - data/1 ~ data/2
  {
    ...
    detailImage: "data/1/描述图(拼接)_1.png", videoUrl: "https://www.youtube.com/embed/HxKN6ugSBac",
  ...
  },
  {
    ...
    detailImage: "data/2/描述图(拼接)_1.jpg", videoUrl: "https://www.youtube.com/embed/7VS4yld1_iY",
  ...
  // 📂 2️⃣ 木漿普通紙巾系列 (category_woodpulp) - data/3 ~ data/7
  {
    ...
    detailImage: "data/3/描述图(拼接)_1.jpg", videoUrl: "https://www.youtube.com/embed/q4y2TstJTak",
  ...
  },
  {
    ...
    detailImage: "data/4/描述图(拼接)_1.jpg", videoUrl: "https://www.youtube.com/embed/bqC6cjs_vUM",
  ...
  },
  {
    ...
    detailImage: "data/5/描述图(拼接)_1.jpg", videoUrl: "https://www.youtube.com/embed/thnPxf12mjk",
  ...
  },
  {
    ...
    detailImage: "data/6/描述图(拼接)_1.jpg", videoUrl: "https://www.youtube.com/embed/thnPxf12mjk",
  ...
  },
  {
    ...
    detailImage: "data/7/描述图(拼接)_1.jpg", videoUrl: "https://www.youtube.com/embed/PLhOHz5_u-w",
  ...
  // 📂 3️⃣ 無塵餐巾紙系列 (category_dustfree) - data/8 ~ data/27 + data/2
  {
    ...
    detailImage: "data/8/描述图(拼接)_1.jpg", videoUrl: "https://www.youtube.com/embed/Lpd4VTCMM8k",
  ...
  },
  {
    ...
    detailImage: "data/9/描述图(拼接)_1.jpg", videoUrl: "https://www.youtube.com/embed/DYk9-ltVSv8",
  ...
  },
  {
    ...
    detailImage: "data/12/描述图(拼接)_1.jpg", videoUrl: "https://youtube.com/shorts/PLhOHz5_u-w?feature=share",
  ...
  },
  {
    ...
    detailImage: "data/20/描述图(拼接)_1.jpg", videoUrl: "https://youtube.com/shorts/PLhOHz5_u-w?feature=share",
  ...
  },
  {
    ...
    detailImage: "data/24/描述图(拼接)_1.jpg", videoUrl: "https://youtube.com/shorts/PLhOHz5_u-w?feature=share",
